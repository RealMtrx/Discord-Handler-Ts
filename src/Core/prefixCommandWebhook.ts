import { WebhookClient, User, Guild } from "discord.js";
...
export async function sendPrefixCommandUsage(
  user: User,
  commandName: string,
  guildName: string
): Promise<void> {
  ...
  try {
    const embed: Record<string, any> = {
      ...
      footer: { text: `${config.botName} • Prefix Command Logger` },
...
export async function sendPrefixCommandError(
  error: Error,
